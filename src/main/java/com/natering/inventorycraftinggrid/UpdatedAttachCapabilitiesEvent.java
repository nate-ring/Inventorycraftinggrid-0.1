 ...
 *
 * Please note that as this is fired or ALL object creations efficient code is recommended.
 * And if possible use one of the sub-classes to filter your intended objects.
 */
public class UpdatedAttachCapabilitiesEvent extends Event
{
    ...
    public UpdatedAttachCapabilitiesEvent(Object obj)
    {
        this.obj = obj;
    }

    public UpdatedAttachCapabilitiesEvent(net.minecraft.item.Item item, Object obj) {
        this.obj = obj;
    }
     ...
     */
    public static class TileEntity extends UpdatedAttachCapabilitiesEvent
    {
     ...
     */
    public static class Entity extends UpdatedAttachCapabilitiesEvent
    {
     ...
     */
    public static class Item extends UpdatedAttachCapabilitiesEvent
    {
